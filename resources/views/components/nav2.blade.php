<nav class="absolute lg:relative lg:flex lg:text-sm bg-indigo-darker lg:bg-transparent pin-l pin-r py-4 px-6 lg:pt-10 lg:pl-12 lg:pr-6 -mt-1 lg:mt-0 overflow-y-auto lg:w-1/6 lg:border-r z-40 hidden">
    <ul class="list-reset mb-8 w-full">
        ...
        {{--<li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4" style="opacity: 1; transform: translateY(0px);">Fiction</li>--}}
        {{--<li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4" style="opacity: 1; transform: translateY(0px);">Nonfiction</li>--}}
        {{--<li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4" style="opacity: 1; transform: translateY(0px);">Lifestyle</li>--}}
        {{--<li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4" style="opacity: 1; transform: translateY(0px);">Health &amp; Fitness</li>--}}
        ...
        {{--</li>--}}
        {{--<li class="hover:text-indigo-dark hover:cursor-pointer transition-normal ml-1 border-l border-grey-dark pl-4" style="opacity: 1; transform: translateY(0px);">Music</li>--}}
        {{--</ul>--}}
        {{--</li>--}}
