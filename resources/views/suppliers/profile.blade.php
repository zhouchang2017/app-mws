...
@section('content')
    ...
    <resource-index-header
            ...
            singular-label="用户"
            :can-create="@json($resource->authorize['canAddUser'])"
            label="用户"
    ></resource-index-header>
    <div class="form-list mb-6">
            ...
            >
                ...
                >
                    <template slot-scope="{row}">
                        <a v-if="row.authorize.canView" class="cursor-pointer text-70 hover:text-primary mr-3"
                        ...
                        <a v-if="row.authorize.canUpdate" class="cursor-pointer text-70 hover:text-primary"
