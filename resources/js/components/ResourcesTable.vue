            ...
            >
                ...
                >
                    <template slot-scope="{row}">
                        <a class="cursor-pointer text-70 hover:text-primary mr-3" :href="`/${resourceName}/${row.id}`">
                        ...
                        <a class="cursor-pointer text-70 hover:text-primary" :href="`/${resourceName}/${row.id}/edit`">
                            <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                 height="24">
                                <path class="heroicon-ui"
