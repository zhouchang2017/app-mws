...
class SupplyShippedNotification extends Notification
{
    use Queueable;

    public static $typeName = '供货计划供应商已发货';
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'supplier_user_name' => $this->supply->latestStatus(Supply::SHIPPED)->user->name,
        ];
    }
}
