...
trait Authorizable
{
     ...
     * @return bool
     */
    public function authorizedToAdd(ErpRequest $request, $model)
    {
        if (! static::authorizable()) {
            return true;
        }
     ...
     * @return bool
     */
    public function authorizedToAttachAny(ErpRequest $request, $model)
    {
        if (! static::authorizable()) {
            return true;
        }
     ...
     * @return bool
     */
    public function authorizedToAttach(ErpRequest $request, $model)
    {
        if (! static::authorizable()) {
            return true;
        }
     ...
     * @return bool
     */
    public function authorizedToDetach(ErpRequest $request, $model, $relationship)
    {
        if (! static::authorizable()) {
            return true;
        }
